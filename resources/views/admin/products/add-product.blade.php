                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="price" id="price" placeholder="قیمت تومانی اثر">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="technique" id="technique" placeholder="تکنیک اثر">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="performDate" id="performDate"
                                           placeholder="تاریخ ایجاد اثر">
                                </div>
                    ...
                    <textarea id="ckeditor" name="ckeditor" class="form-control" style="height: 300px">
                        ...
                        <div id="persianPart" class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <input class="form-control" name="pName" id="pName" value="" placeholder="نام اثر">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="pTechnique" id="pTechnique" value="" placeholder="تکنیک اثر">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="pPerformDate" id="pPerformDate" value="" placeholder="تاریخ ایجاد اثر">
                                </div>
