        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>آثار</li>
                    <li class="active">افزودن سنتور</li>
                </ol>
            </section>
            <form action="{{ route('santoor.store') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="box box-solid">
                                <div class="box-header with-border">
                                    <h3 class="box-title" id="image_title">تصویر اصلی سنتور</h3>
                                ...
                                <div class="box-body no-padding">
                                    <div class="input-group" style="width: 100%;padding: 10px">
                                        ...
                                        <button type="button" class="browse btn btn-primary" id="imageUpload"
                                            style="width: 100%;padding: 10px;margin: auto"> انتخاب تصویر با ابعاد
                                            ۴۴۰*۳۵۰
                                        </button>
                                ...
                                <div class="box-body no-padding">
                                    <div class="input-group gallery-box" id="gallery-box" style="display: block;">
                                        ...
                                        <input hidden type="text" style="width: 100%;height: 100%"
                                            id="featured_image1" placeholder="آدرس تصویر" readonly name="gallery1" />
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio">
                                            <label><input type="radio" value="0" name="selled">خیر</label>
                                        </div>
                                    </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" name="pBuildDate" id="pBuildDate"
                                            placeholder="تاریخ ساخت سنتور">
                                    </div>


                                    <div class="form-group">
                                        <textarea id="pCkeditor" name="pCkeditor" class="form-control" style="height: 300px"></textarea>
                                    </div>
                                ...
                                <div class="box-footer">
                                    <div class="pull-right">
                                        ...
                                        <button type="submit" class="btn btn-primary"
                                            onclick="return productvalidate()"><i class="fa fa-share"></i> انتشار
                                        </button>
                                    </div>
                                </div>
                            </div>
